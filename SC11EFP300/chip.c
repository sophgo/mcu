...
void sys_rst_enable(void)
{
	...
	gpio_bit_set(SYS_RST_X_H_BM2_PORT, SYS_RST_X_H_BM2_PIN);
	gpio_bit_set(SYS_RST_X_H_BM3_PORT, SYS_RST_X_H_BM3_PIN);
...
void sys_rst_disable(void)
{
	...
	gpio_bit_reset(SYS_RST_X_H_BM2_PORT, SYS_RST_X_H_BM2_PIN);
	gpio_bit_reset(SYS_RST_X_H_BM3_PORT, SYS_RST_X_H_BM3_PIN);
}
