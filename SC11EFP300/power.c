...
void check_gpio_power_good(void)
{
	...
	struct node_power_good pg_nodes[] = {
		...
		{.port = (unsigned long)PG_DDR_VDD_BM2_PORT, .pin = (unsigned long)PG_DDR_VDD_BM2_PIN, .name = "PG_DDR_VDD_BM2"},
		{.port = (unsigned long)PG_VDDC_BM2_PORT, .pin = (unsigned long)PG_VDDC_BM2_PIN, .name = "PG_VDDC_BM2"},
		{.port = (unsigned long)PG_VDDR_BM2_PORT, .pin = (unsigned long)PG_VDDR_BM2_PIN, .name = "PG_VDDR_BM2"},
		{.port = (unsigned long)PG_DDR_VDD_BM3_PORT, .pin = (unsigned long)PG_DDR_VDD_BM3_PIN, .name = "PG_DDR_VDD_BM3"},
		{.port = (unsigned long)PG_VDDC_BM3_PORT, .pin = (unsigned long)PG_VDDC_BM3_PIN, .name = "PG_VDDC_BM3"},
		{.port = (unsigned long)PG_VDDR_BM3_PORT, .pin = (unsigned long)PG_VDDR_BM3_PIN, .name = "PG_VDDR_BM3"},
	};
