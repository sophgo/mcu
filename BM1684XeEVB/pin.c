...
void pin_init(void)
{
	...
	GPIO_OSPEEDR(GPIOA) =
	    ...
	    (GPIO_OSPEED_LOW << (11 * 2)) | (GPIO_OSPEED_HIGH << (12 * 2)) |
	...
	GPIO_PUPDR(GPIOA) =
	    ...
	    (GPIO_PUPD_PULLDOWN << (10 * 2)) | (GPIO_PUPD_NONE << (11 * 2))
	...
	GPIO_OSPEEDR(GPIOB) =
	    ...
	    (GPIO_OSPEED_LOW << (4 * 2)) | (GPIO_OSPEED_LOW << (5 * 2)) |
	...
	GPIO_MODER(GPIOB) =
	    ...
	    (GPIO_MODE_OUTPUT << (4 * 2)) | (GPIO_MODE_OUTPUT << (5 * 2)) |
