...
const static unsigned short version_table[] = {
	199, 534, 945, 1310, 658, 2048, 2438, 2796, 3148, 3514, 3901, 
};
...
static void __attribute__((unused)) adc2tmp2(unsigned short adc)
{
	float f = 4390.0/298.15 + logf(4096.0f/adc - 1.0f);

	ntc_tmp = (int)(4390.0f / f -273.15);
