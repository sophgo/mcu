...
struct power_node board_power_nodes[20] = {
	...
	{"CHECK-VDD-TPU", NODE_TYPE_CHECK, POWER_STATUS_OFF, 0,
	...
	{"VDD-TPU-MEM", NODE_TYPE_ENABLE, POWER_STATUS_OFF, 0,
	 {(unsigned long)EN_VDD_TPU_MEM_PORT,
	  (unsigned long)EN_VDD_TPU_MEM_PIN},
	 },

	{"CHECK-TPU-MEM", NODE_TYPE_CHECK, POWER_STATUS_OFF, 0,
	 {(unsigned long)PG_VDD_TPU_MEM_PORT,
	  (unsigned long)PG_VDD_TPU_MEM_PIN},
	 },

	{"ACK-TPU_MEM", NODE_TYPE_ENABLE, POWER_STATUS_OFF, 0,
