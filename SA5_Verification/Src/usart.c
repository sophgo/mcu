...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspInit 0 */
    ...
    PB11     ------> LPUART1_RX 
    */
    GPIO_InitStruct.Pin = UART0_RX_Pin|UART0_TX_Pin;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB11     ------> LPUART1_RX 
    */
    HAL_GPIO_DeInit(GPIOB, UART0_RX_Pin|UART0_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX 
    */
    HAL_GPIO_DeInit(GPIOA, UART1_RX_Pin|UART1_TX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PA1     ------> USART4_RX 
    */
    HAL_GPIO_DeInit(GPIOA, UART2_RX_Pin|UART2_TX_Pin);
