...
static void system_gpio_init(void)
{
	...
	/* GPIOA */
	/* GPIOA OUTPUT PINS*/
	pins = GPIO_PIN_4 | GPIO_PIN_7 | GPIO_PIN_11;
	gpio_bit_reset(GPIOA, pins);
	gpio_init(GPIOA, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);

	/* GPIOA INPUT PINS */
	pins = GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14\
		 | GPIO_PIN_15;
	...
	/* GPIOB */
	/* GPIOB OUTPUT PINS*/
	pins = GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14;
	gpio_bit_reset(GPIOB, pins);
	gpio_init(GPIOB, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);

	/* GPIOB INPUT PINS*/
	gpio_init(GPIOB, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, GPIO_PIN_2 | GPIO_PIN_8 | GPIO_PIN_9);
	...
	/* GPIOC */
	/* GPIOC OUTPUT PINS*/
	pins = GPIO_PIN_5 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14;
	gpio_bit_reset(GPIOC, pins);
	gpio_init(GPIOC, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);

	/* GPIOC INPUT PINS */
	pins = GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_7 | GPIO_PIN_8;
