...
static const struct stlink_chipid_params devices[] = {
    ...
    {
        // GD32E50X
        .chip_id = STLINK_CHIPID_GD32_E50X,
        .description = "GD32E50x",
        .flash_type = STLINK_FLASH_TYPE_GD32E50X,
        .flash_size_reg = 0x1ffff7e0, // "Flash size register" (p.3286)
        .flash_pagesize = 8 * 1024,    // 8K
        .sram_size = 0,         // sram size and flash size are located at the same register
        .bootrom_base =
            0x1FFFB000,          // "System memory" starting address (Table 6)
        .bootrom_size = 0x3800, // "System memory" byte size in hex (Table 6)
        .option_base = STM32_GD32E50X_OPTION_BYTES_BASE,
        .option_size = 16,
        .flags = CHIP_F_HAS_SWO_TRACING,
    },
    {
