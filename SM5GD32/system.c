...
static void __attribute__((unused)) system_uart_init(void)
{
...
static void system_gpio_init(void)
{
	...
	gpio_init(GPIOB, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ,
		  GPIO_PIN_2 | GPIO_PIN_5 | GPIO_PIN_7);

	pins = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_3 | GPIO_PIN_6 |
		GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;

	gpio_bit_reset(GPIOB, pins & ~GPIO_PIN_6);
	...
	/* GPIOD */
	gpio_init(GPIOD, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ,
