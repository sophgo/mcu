...
/* Conflicted between EVB and ACP */
/* PA  9 definition depends on board type */
#define EN_VDD_1V8_RTC_EVB_PORT		GPIOA
#define EN_VDD_1V8_RTC_EVB_PIN		GPIO_PIN_9
#define EN_VDD_1V8_RTC_EVB_EXTI		EXTI_9
#define GPIO_LTE_PWR_EN_ACP_PORT	GPIOA
#define GPIO_LTE_PWR_EN_ACP_PIN		GPIO_PIN_9
#define GPIO_LTE_PWR_EN_ACP_EXTI	EXTI_9
/* PA 10 definition depends on board type */
#define EN_VDD_0V8_RTC_EVB_PORT		GPIOA
#define EN_VDD_0V8_RTC_EVB_PIN		GPIO_PIN_10
#define EN_VDD_0V8_RTC_EVB_EXTI		EXTI_10
#define GPIO_LTE_RST_ACP_PORT		GPIOA
#define GPIO_LTE_RST_ACP_PIN		GPIO_PIN_10
#define GPIO_LTE_RST_ACP_EXTI		EXTI_10
/* PA 11 definition depends on board type */
#define EN_12V0_EVB_PORT			GPIOA
#define EN_12V0_EVB_PIN				GPIO_PIN_11
#define EN_12V0_EVB_EXTI			EXTI_11
...
/* Conflicted between EVB and ACP */
/* PE 6 definition depends on board type */
#define EN_12V_SYS_ACP_PORT			GPIOE
#define EN_12V_SYS_ACP_PIN			GPIO_PIN_6
#define EN_12V_SYS_ACP_EXTI			EXTI_6
/* PE 13 definition depends on board type */
#define EN_VDD_0V8_RTC_ACP_PORT		GPIOE
#define EN_VDD_0V8_RTC_ACP_PIN		GPIO_PIN_13
#define EN_VDD_0V8_RTC_ACP_EXTI		EXTI_13
/* PE 14 definition depends on board type */
#define EN_VDD_1V8_RTC_ACP_PORT		GPIOE
#define EN_VDD_1V8_RTC_ACP_PIN		GPIO_PIN_14
#define EN_VDD_1V8_RTC_ACP_EXTI		EXTI_14
