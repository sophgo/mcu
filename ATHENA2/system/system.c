...
static void system_uart_init(void)
{
	...
	gpio_init(MCU_USART_TX_PORT, GPIO_MODE_AF_PP, GPIO_OSPEED_10MHZ, MCU_USART_TX_PIN);
	gpio_init(MCU_USART_RX_PORT, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_10MHZ, MCU_USART_RX_PIN);
...
static void system_gpio_init(void)
{
	...
	/* GPIOE OUTPUT PINS */
	pins = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4;
...
//	debug("[%3lu] %-25s :  %-20s :  %4d\n", chip_uptime(), __FUNCTION__, __FILE__, __LINE__);
    ...
    /* GPIOC OUTPUT PINS */
    pins = GPIO_PIN_1 | GPIO_PIN_13 | GPIO_PIN_9;
    gpio_bit_reset(GPIOC, pins);
    gpio_init(GPIOC, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);
    ...
    /* GPIOE OUTPUT PINS */
    pins = GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;
    gpio_bit_reset(GPIOE, pins);
    gpio_init(GPIOE, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);
}
