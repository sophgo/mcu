...
static void system_uart_init(void)
{
	...
	usart_baudrate_set(CONSOLE_UART, 115200);
...
static void system_gpio_init(void)
{
	...
	/* GPIOB */
	/* GPIOB INPUT PINS*/
	pins = GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_8
	...
	/* GPIOD */
	/* GPIOD OUTPUT PINS*/
	pins = GPIO_PIN_8 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14;
