...
static void system_gpio_init(void)
{
	...
	/* GPIOA INPUT PINS */
	pins = GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6;
	gpio_init(GPIOA, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, pins);

	/* GPIOA ANALOG*/
	gpio_init(GPIOA, GPIO_MODE_AIN, GPIO_OSPEED_2MHZ, GPIO_PIN_0 | GPIO_PIN_1);

	/* -------------------------- GPIOB -------------------------- */
	/* GPIOB OUTPUT PINS*/
	pins = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;
	gpio_bit_reset(GPIOB, pins);
	gpio_init(GPIOB, GPIO_MODE_OUT_PP, GPIO_OSPEED_2MHZ, pins);

	/* GPIOB INPUT PINS*/
	pins = GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_9;
	gpio_init(GPIOB, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ,pins);

	/* -------------------------- GPIOC --------------------------*/
	/* GPIOC OUTPUT PINS*/
	pins = GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_8 | GPIO_PIN_10 | GPIO_PIN_12;
	...
	/* GPIOD INPUT PINS*/
	pins = GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3;
	...
	gpio_bit_reset(GPIOE, pins);
	gpio_init(GPIOE, GPIO_MODE_OUT_PP, GPIO_OSPEED_MAX, pins);


	/* GPIOE INPUT PINS*/
	pins = GPIO_PIN_0 | GPIO_PIN_2 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_10 | GPIO_PIN_11;
