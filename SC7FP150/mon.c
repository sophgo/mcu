...
static struct filter mp5475_current[3][4];
static struct filter mp5475_voltage[3][4];
static struct filter isl68224_current[6][3];
static struct filter isl68224_voltage[6][3];
static struct filter isl68224_power[6][3];
static struct filter isl68224_rdrop[6][3];
...
static void __maybe_unused broadcast(void)
{
	...
	dbgi2c_pkg.vdd_phy.current =
		pkg.isl68224[isl68224_idx].rail[2].current;
	dbgi2c_pkg.vdd_phy.power =
		pkg.isl68224[isl68224_idx].rail[2].power;
