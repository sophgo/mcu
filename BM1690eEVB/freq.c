...
static int sg2044_pll_write(int id, int value)
{
	return top_misc_write(PLL_CTRL_OFFSET + (id << 3), value);
}

static int sg2044_pll_read(int id, uint32_t *pvalue)
{
	return top_misc_read(PLL_CTRL_OFFSET + (id << 3), pvalue);
}

static inline int sg2044_pll_write_l(int id, int value)
{
	return top_misc_write(PLL_CTRL_OFFSET + (id << 3) - 4, value);
}

static inline int sg2044_pll_read_l(int id, uint32_t *pvalue)
{
	return top_misc_read(PLL_CTRL_OFFSET + (id << 3) - 4, pvalue);
}
...
int sg2044_clk_pll_set_rate(int mpll_id, uint64_t rate, uint64_t parent_rate)
{
	...
	sg2044_pll_switch_mux(sg2044_pll, 1);
	...
	sg2044_pll_read(sg2044_pll->id, &value);
	...
	sg2044_pll_write(sg2044_pll->id, value);
	sg2044_pll_enable(sg2044_pll, 1);
	/* switch back to mpll after modify mpll */
	sg2044_pll_switch_mux(sg2044_pll, 0);
out:
