...
struct power_node const board_power_nodes[16] = {
	...
	{"EN_DDR_VDD", NODE_TYPE_ENABLE, 10000,
	 {(unsigned long)EN_DDR_VDD_PORT, (unsigned long)EN_DDR_VDD_PIN},
	 },

	{"EN_VDD_1V2", NODE_TYPE_ENABLE, 10000,
