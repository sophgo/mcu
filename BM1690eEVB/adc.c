...
#define ATX_12V_CHANNEL		ADC_CHANNEL_0
#define PCIE_12V_CHANNEL	ADC_CHANNEL_1
#define PCIE_3V3_CHANNEL	ADC_CHANNEL_2
#define PCB_VRE0_CHANNEL	ADC_CHANNEL_10
#define BOM_VRE0_CHANNEL	ADC_CHANNEL_11
...
{
	unsigned long adc_data = adc_read(ATX_12V_CHANNEL);
