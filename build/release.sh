#!/bin/bash
list='sm5g se5lite sm5gd32 bm1684evb sa5 sc5h sc5plus sm5mini sc5pro bm1684xevb sc7pro sc7hp75 sc7fp150 sg2042evb sg2042revb wolfclaw sg2042x4 sm7mini sm7mqy athena2evb athena2acp sm7g sm7m_mp_1_1 sm7m_mp_1_2 bm1690evb'
top="$PWD/.."
